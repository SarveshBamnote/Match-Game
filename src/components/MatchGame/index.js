...
class MatchGame extends Component {
  ...
  getRandomImageUrl = () => {
    const randomImageIndex = Math.ceil(Math.random() * (imagesList.length - 1))
    const getActiveId = imagesList[randomImageIndex].id
    const getActiveImg = imagesList[randomImageIndex].imageUrl
    this.setState({activeImageUrl: getActiveImg, activeImageId: getActiveId})
  }
  ...
  render() {
    const {timer, score, activeTabId, activeImageUrl} = this.state
    const filteredActiveImages = this.getActiveTabImages()
          ...
          <div className="footer-container">
            ...
            {gameOver && (
              <div className="game-over-container">
                ...
                />
                <p className="play-again-text">YOUR SCORE</p>
